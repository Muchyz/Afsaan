    ...
    <footer className="bg-navy text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-16 grid gap-10 md:gap-12 md:grid-cols-4">
        <div className="text-center md:text-left pb-8 md:pb-0 border-b border-white/10 md:border-0">
          ...
          <div className="flex items-center justify-center md:justify-start gap-3.5 mt-5">
            <a href={`https://wa.me/${business.whatsapp}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
              className="w-10 h-10 rounded-full flex items-center justify-center ring-1 ring-white/15 shadow-lg transition-all duration-300 hover:scale-110 hover:ring-white/30" style={{ background: '#25D366', boxShadow: '0 4px 14px rgba(37,211,102,0.35)' }}>
            ...
            <a href="https://www.facebook.com/afsaan.welders.n.painters" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
              className="w-10 h-10 rounded-full flex items-center justify-center ring-1 ring-white/15 shadow-lg transition-all duration-300 hover:scale-110 hover:ring-white/30" style={{ background: '#1877F2', boxShadow: '0 4px 14px rgba(24,119,242,0.35)' }}>
            ...
            <a href="https://www.instagram.com/afsaan_weldersnpainters" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              className="w-10 h-10 rounded-full flex items-center justify-center ring-1 ring-white/15 shadow-lg transition-all duration-300 hover:scale-110 hover:ring-white/30" style={{ background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', boxShadow: '0 4px 14px rgba(220,39,67,0.35)' }}>
            ...
            <a href="https://vm.tiktok.com/ZS9SDJ9gJ9Neo-LDB64/" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
              className="w-10 h-10 rounded-full flex items-center justify-center ring-1 ring-white/15 shadow-lg transition-all duration-300 hover:scale-110 hover:ring-white/30" style={{ background: '#010101', boxShadow: '0 4px 14px rgba(0,0,0,0.5)' }}>
            ...
            <a href={`tel:${business.phone}`} aria-label="Phone"
              className="w-10 h-10 rounded-full flex items-center justify-center ring-1 ring-white/15 shadow-lg transition-all duration-300 hover:scale-110 hover:ring-white/30" style={{ background: '#1C8FD6', boxShadow: '0 4px 14px rgba(28,143,214,0.35)' }}>
