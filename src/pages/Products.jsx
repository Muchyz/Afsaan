...
export default function Products() {
  return (
    <div className="container-page py-12 md:py-16">
      ...
      <h1 className="text-3xl md:text-4xl font-bold mb-4 text-navy text-center">Shop Our Gates</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {products.map((p) => {
          ...
          return (
            <div key={p.id} className="bg-white rounded-2xl shadow-lg shadow-slate/10 overflow-hidden border border-slate/10">
