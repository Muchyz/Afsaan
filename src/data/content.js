...
export const services = [
  { slug: 'sliding-gates', title: 'Sliding Gates', icon: 'MoveHorizontal', short: 'Space-saving steel sliding gates built for daily use.', description: 'Heavy-duty sliding gates fabricated from steel box sections, finished smooth and painted to match your compound. Built with reinforced rollers and track systems for long-term, low-maintenance operation, with the option to add an automated opener.', material: 'Steel box section, 2mm–3mm gauge, primed and painted', turnaround: '4 – 7 days depending on size', img: unsplash('photo-1590869942905-a4ada45d5a8a'), gallery: [unsplash('photo-1590869942905-a4ada45d5a8a'), unsplash('photo-1580047750144-2c7790adf461')] },
  { slug: 'swing-gates', title: 'Swing Gates', icon: 'DoorOpen', short: 'Classic double or single swing gates with custom patterns.', description: 'Traditional swing gates, built single or double leaf, in flat-bar, tube, or sheet-clad designs. Every gate is custom-measured on site and hung on heavy-duty hinges rated for daily opening and closing.', material: 'Mild steel flat bar / box section, welded and painted', turnaround: '3 – 6 days depending on size', img: unsplash('photo-1746155885811-ace3b5afd12d'), gallery: [unsplash('photo-1746155885811-ace3b5afd12d'), unsplash('photo-1695559557666-d1b86621b5e4')] },
